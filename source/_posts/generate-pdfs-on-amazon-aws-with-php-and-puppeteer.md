...
{% codeblock serverless.yml lang:yml mark:11-13,31-33 %}
service: app
...
{% codeblock serverless.yml lang:yml mark:8 %}
# ...
...
{% codeblock serverless.yml lang:yml mark:6 %}
#...
...
{% codeblock src/Chromium/Chromium.php lang:php %}
...
{% codeblock src/Chromium/Factory/ChromiumFactory.php lang:php %}
<?php declare(strict_types=1);
...
{% codeblock config/services.yaml lang:yml %}
services:
